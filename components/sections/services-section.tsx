...
import {
  Map, Layers, Database, Settings, Eye, Building2, GraduationCap, ArrowRight, Sparkles, X, ChevronRight, MapPin, MessageCircle
} from "lucide-react"
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  style={{
                    ...
                    boxShadow: `0 3px 12px ${service.accent}40`,
                    color: "#fff",
                  }}
                >
