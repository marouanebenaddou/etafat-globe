    ...
    >
      ...
      {ctaLabel && (
        <div className="flex justify-center">
          <a
            href={ctaHref}
            className="mt-[-20px] inline-flex items-center justify-center w-fit md:w-52 z-20 px-6 py-3 rounded-lg bg-[#007BFF] hover:bg-[#00669D] text-white font-semibold tracking-tighter text-lg transition-all duration-300 shadow-lg shadow-[#007BFF]/30 hover:scale-105"
          >
            {ctaLabel}
          </a>
        </div>
