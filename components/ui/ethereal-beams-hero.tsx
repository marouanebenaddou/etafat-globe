...
export default function EtherealBeamsHero() {
  ...
  const navItems = [
    { label: "Accueil",      href: "#home" },
    {
      ...
      children: [
        { label: "SIG & Géomatique",              href: "#service-syst-mes-d-information-g-ographique" },
        { label: "Foncier & Topographie",         href: "#service-foncier-topographie" },
        { label: "Ingénierie des Données",        href: "#service-ing-nierie-des-donn-es" },
        { label: "Conseil en Ingénierie",         href: "#service-conseil-en-ing-nierie" },
        { label: "Inspection d'Infrastructures",  href: "#service-inspection-d-infrastructures" },
        { label: "BIM & Digital",                 href: "#service-bim-digital" },
      ],
    },
    {
      label: "Marchés", href: "#marches",
      children: [
        { label: "Infrastructures",           href: "#marche-infrastructures" },
        { label: "Aménagement du Territoire", href: "#marche-am-nagement-du-territoire" },
        { label: "Énergie & Mines",           href: "#marche-nergie-mines" },
        { label: "Agriculture",               href: "#marche-agriculture" },
        { label: "Cartographie",              href: "#marche-cartographie" },
      ],
    },
    {
      label: "Technologies", href: "#technologies",
      children: [
        { label: "Drones & UAV",   href: "#tech-drones-uav" },
        { label: "LiDAR",          href: "#tech-lidar" },
        { label: "GPS / GNSS",     href: "#tech-gps-gnss" },
        { label: "Mobile Mapping", href: "#tech-mobile-mapping" },
        { label: "Bathymétrie",    href: "#tech-bathym-trie" },
        { label: "Laser Scanning", href: "#tech-laser-scanning" },
      ],
    },
